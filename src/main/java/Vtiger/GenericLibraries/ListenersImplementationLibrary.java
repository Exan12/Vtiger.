...
public class ListenersImplementationLibrary implements ITestListener
{
	...
	public void onTestFailure(ITestResult result) 
	{
		...
		try {
			...
			String patch = wLib.takeScreenshot(BaseClass.sDriver, METHODNAME);
			test.addScreenCaptureFromPath(patch);
	...
	public void onStart(ITestContext context)
	{
		...
		htmlReports.config().setDocumentTitle("Extent Reports For V-Tiger Applicaction");
		...
		report.setSystemInfo("Reporter Name", "RATNA KIRAN");
